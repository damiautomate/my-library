...
function PassportContent() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 pb-20 pt-8 sm:px-6 sm:pb-24 sm:pt-10">
      <header className="mb-10 border-b ml-hairline pb-4">
        ...
        <h1 className="mt-2 font-display text-3xl tracking-tightest sm:text-4xl md:text-5xl">
